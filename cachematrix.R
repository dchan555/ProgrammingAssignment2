...
makeVector <- function(x = matrix()) {
  mat_inv <- NULL ##begins by setting the mean to NULL as a placeholder for a future value
  ...
  set_inverse <- function(inverse) mat_inv <<- inverse ##sets the mean, m, to mean
  get_inverse <- function() mat_inv ##returns the mean, m
  list(set = set, get = get, ##returns the vector containing all of the functions just defined
